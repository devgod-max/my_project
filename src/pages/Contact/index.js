      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        ...
        >
          ...
          <div className="flex items-center my-6">
            ...
            <h3 className="font-medium text-primary">Davi Souza Costa</h3>
          </div>
          <div className="flex items-center my-6">
          ...
          <div className="flex items-center my-6">
            ...
            <h3 className="font-medium text-primary">davicostasocial1994@gmail.com</h3>
          </div>
          <div className="flex items-center my-6">
          ...
          <div className="mt-8 flex items-center">
            ...
            <a
              href="https://www.linkedin.com/in/davi-souza-costa-a41048339/"
              target="blank"
            ...
            <a
              href="https://www.github.com/devgod-max827"
              target="blank"
              className="text-3xl text-neutral hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
            >
